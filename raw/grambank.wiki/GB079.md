## Do verbs have prefixes or proclitics other than S, A or P indexes (do include indexes that also mark TAM or negation)?

## Summary
This feature targets the existence of [affixation](https://github.com/grambank/grambank/wiki/Affixes-and-clitics) is attached to the beginning of a stem, [productive](https://github.com/grambank/grambank/wiki/Productivity), and dedicated to one or more specific grammatical functions.
